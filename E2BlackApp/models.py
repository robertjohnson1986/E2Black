...
class MessageManager(models.Manager):
    def message_validator(self, postData):
        ...
        if len(postData['message']) <3:
            errors['title'] = "Job must be at least 3 characters"
...
class Books(models.Model):
    ...
    location = models.CharField(max_length=255, default="Text")
    other = models.CharField(max_length=255, default="Text")
    pet_care = models.CharField(max_length=255, default="Text")
    electrical =models.CharField(max_length=255, default="Text")
    garden = models.CharField(max_length=255, default="Text")
